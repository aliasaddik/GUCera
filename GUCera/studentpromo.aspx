...
#Label3{
   ...
   font-size: 20px;
    ...
    <form id="form1" runat="server">
        <h1>Issue Promocode to student</h1>

    
        <p>
            <asp:Label ID="Label1" runat="server" Text="Student ID:"></asp:Label><br />
            <asp:TextBox ID="sid" runat="server"></asp:TextBox><br />
            <asp:Label ID="Label2" runat="server" Text="Promocode:"></asp:Label><br />
            <asp:TextBox ID="pid" runat="server"></asp:TextBox><br />
        </p>
         <p>
            <asp:Button ID="Button1" class="submit" runat="server" Text="issue promocode" OnClick="Button1_Click" /><br />
